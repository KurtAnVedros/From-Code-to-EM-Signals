...
def mapCodeSignal(Signal, Code, padding, startCycleCut = 0, labels=True):
    cycleOn = 0
    ...
    listCodes.append(["andi", 1, "tab:Brown", 0])
    ...
    listCodes.append(["muls", 2, "darkgray", 0])
    ...
    listCodes.append(["ori", 1, "black", 0])
    listCodes.append(["out", 1, "tab:red", 0])
    listCodes.append(["pop", 2, "yellow", 0])
    ...
    listCodes.append(["sbc", 1, "crimson", 0])
    listCodes.append(["sbci", 1, "darkgreen", 0])
    listCodes.append(["sbi", 2, "orange", 0])
    listCodes.append(["sbiw", 2, "violet", 0])
    listCodes.append(["sbis-f", 1, "deeppink", 0])
    listCodes.append(["sbis-t-1", 2, "crimson", 0])
    listCodes.append(["sbis-t-2", 3, "dodgerblue", 0])
